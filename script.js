// Arrays com 20 perguntas para cada tema
const questionsPortugues = [
...
// Função para começar o jogo com o tema escolhido
function startGame(theme) {
    currentTheme = theme;
    switch(theme) {
        case 'portugues':
            questions = questionsPortugues;
            break;
        case 'matematica':
            questions = questionsMatematica;
            break;
        case 'historia':
            questions = questionsHistoria;
            break;
        case 'ciencias':
            questions = questionsCiencias;
            break;
        default:
            questions = questionsPortugues; // Tema padrão
    }
...
function endGame() {
    ...
    playAgainButton.onclick = () => startGame(currentTheme);
}