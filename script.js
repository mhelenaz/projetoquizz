...
const questions = {
    portugues: {
        ...
        medium: [
            ...
            { question: "Qual a função do 'se' na frase 'João se machucou'?", options: ["Conjunção", "Partícula expletiva", "Índice de indeterminação do sujeito", "Partícula apassivadora"], answer: "Partícula apassivadora" },
...
// Função para embaralhar um array e pegar N elementos
function getRandomQuestions(arr, numQuestions) {
    // Cria uma cópia do array para não modificar o original
    const shuffled = arr.sort(() => 0.5 - Math.random());
    // Retorna os primeiros 'numQuestions' elementos
...
function showQuestion() {
    ...
    questionText.textContent = `Pergunta ${currentQuestionIndex + 1} de ${questionsList.length}: ${currentQuestion.question}`;
